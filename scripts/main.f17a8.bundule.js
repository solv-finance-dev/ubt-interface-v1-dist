...
// Mumbai
const invoiceDelegateAddress = '0xb901fC47B0284517677E380d58493fbe646E9509';
const invoiceSvgAddress = '0x67eD58F002E8462B6a2D22A1B1aD7Acb101e4420';
const receivableDelegateAddress = '0xc4D43F6D49144Ab632991113d3bAb166CF99fD44';
const receivableSvgAddress = '0x7fBf47CbBdab903971fE809D008394EF9C305a3e';
...
const users = [
    // { name: 'Rothschild', value: '0xe35907Bb6EA969b59374f1Cb84E7BB8338cc9842', icon: <img src={RCIcon} /> },
    {
        name: 'Rothschild',
...
function Topbar() {
    ...
    (0,react.useEffect)(()=>{
        if (isActive && account && (!chainId || chainId !== dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI)) {
            onOpenSwitchChainModel();
        }
        getWeAudBalance();
        const timerId = setInterval(()=>{
            if (isActive && account && chainId === dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI) {
                getWeAudBalance();
            }
        }, TIMER_INTERVAL);
    ...
    const onOpenSwitchChainModel = (0,react.useCallback)(()=>{
        switchChain(dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI);
    }, []);
    ...
    const showSearchBar = account && chainId === dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI && (pathname === '/pay' || pathname === '/trade' || pathname === '/get-paid' || pathname === '/my-issurance');
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                                ...
                                                children: [
                                                    ...
                                                    chainId === dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI ? /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                                        className: "text-[#959A9F]",
                                                        children: "Mumbai Testnet"
                                                    }) : /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                                        className: "text-red",
                                                ...
                                                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(menu/* Menu.Item */.v.Item, {
                                                    children: ({ active , close  })=>/*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                                                            children: [
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                                                            ...
                                                                            children: [
                                                                                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                                                                    ...
                                                                                    children: [
                                                                                        /*#__PURE__*/ (0,jsx_runtime.jsx)("a", {
                                                                                            href: (0,dist/* getExplorerLink */.E8)(chainId || dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI, account, dist/* ExplorerDataType.ADDRESS */.rl.ADDRESS),
                                                                                            target: "_blank",
                                                                                            children: shortenAddress(account)
                                                                                        }),
                                                                                ...
                                                                                chainId === dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI && !!weAudBalance && /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
                                                                                    className: "text-[#959A9F]",
                                                                                    children: [
                                                                                        "Balance: ",
                                                                                        /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                                                ...
                                                                chainId !== dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI ? /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                                                                    ...
                                                                    children: "Switch to the Mumbai Testnet"
                ...
                children: /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(GetPaid_ItemButton, {
                            url: `https://testnets.opensea.io/assets/mumbai/${receivableDelegateAddress}/${selectedReceivable == null ? void 0 : selectedReceivable.id}`,
...
function Dashboard() {
    ...
    const handleWalletConnect = (0,react.useCallback)(()=>{
        ...
        if (!chainId || chainId !== dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI) {
            switchChain(dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI);
            return false;
        }
        return true;
...
const client = (0,urql_core/* createClient */.eI)({
    url: "https://api.thegraph.com/subgraphs/name/solv-victor/ubt-mumbai" || 0,
    exchanges: [
...
const App = ()=>{
    const { account , chainId , switchChain  } = (0,dist/* useWeb3Provider */.xo)();
    const [showWalletModal, setShowWalletModal] = (0,react.useState)(false);
    const routing = (0,react_router_dist/* useRoutes */.V$)(web_routes(!!account && !!chainId && chainId === dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI));
    ...
    (0,react.useEffect)(()=>{
        const timerId = setTimeout(()=>{
            if ((!account || chainId !== dist/* SupportedChainId.POLYGON_MUMBAI */.HL.POLYGON_MUMBAI) && pathname !== '/') {
                handleWalletConnect();
                navigate('/');
            }
        }, 1000);
